...
class JuliaSimulator(Simulator):
    """
    ...
    **kwargs : dict
    ...
    def __init__(self, model, tspan=None, initials=None, param_values=None,
        ...
        super(JuliaSimulator, self).__init__(model,
                                             tspan=tspan,
                                             initials=initials,
    ...
    def run(self, tspan=None, initials=None, param_values=None,
        ...
        """
        super(JuliaSimulator, self).run(tspan=tspan,
                                        initials=initials,
                                        param_values=param_values,
                                        _run_kwargs=[])
...
class SerialExecutor(Executor):
    ...
    # """ Simulate a model using Julia solvers through diffeqpy """
    # _supports = {
    #     'multi_initials':     True,
    #     'multi_param_values': True
    # }
    ...
    def run(self, tspan=None, initials=None, param_values=None, n_runs=1,
        ...
        self._logger.info('Running %d Julia %s simulations' % (total_sims,
                                                             method))
